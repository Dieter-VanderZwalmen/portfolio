    ...
    return (
        ...
        <div className='projects whitebackground' id='projects'>
            ...
            {/* https://icon-sets.iconify.design/?query=light%20bulb */}
                ...
                <CardFlip title="Ray tracing" subtitle="Ray tracing in C++ " img="akar-icons:light-bulb" text="Selfmade implementation of ray tracing made in C++" githublink="https://github.com/Dieter-VanderZwalmen/raytracer-3d-Erdem-Mattias-Dieter-main"/>
                ...
                <CardFlip img="mdi:unity" title="Unity game" subtitle="Among us like game " text="Working together as a team of four on our graduation project, we aimed to create an Among Us-like game that would subtly incorporate educational elements into its gameplay." githublink="https://github.com/Dieter-VanderZwalmen/afstudeerProject" />
                ...
                <CardFlip img="bxl:flutter" title="Mobile application" subtitle="Mobile application" text="Mobile application made with flutter for Android and IOS that makes keeping an overview of all your tasks easy. " githublink="https://github.com/Dieter-VanderZwalmen/tasker" /> 
                ...
                <CardFlip title="Datamining & AI" subtitle="Datamining with Python, Jupyter and Python. " text="Datamining & AI with Python, Jupyter notebooks. Visualizing, correcting and displaying data to create a consensus." img="eos-icons:data-mining" githublink="https://github.com/Dieter-VanderZwalmen/DATA-And-AI-Assignment-3-main" />
