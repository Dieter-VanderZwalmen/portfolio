    ...
    return (
        ...
        <div className='projects whitebackground' id='projects'>
            ...
            {/* https://icon-sets.iconify.design/?query=light%20bulb */}
                ...
                <CardFlip title="Datamining" subtitle="Datamining with Python, Jupyter and Python. " text="Datamining with Python, Jupyter and Python. Visualizing, correcting and displaying data to create a consensus." img="eos-icons:data-mining" githublink="https://github.com/Dieter-VanderZwalmen/DATA-And-AI-Assignment-3-main" />
{/* 
